...
import cls from "./ThemeToogler.module.css";
  ...
  return (
    <label className={cls.switch}>
      ...
      <span className={cls.slider}>
        <div className={`${cls.star} ${cls.star_1}`}></div>
        <div className={`${cls.star} ${cls.star_2}`}></div>
        <div className={`${cls.star} ${cls.star_3}`}></div>
        <svg viewBox="0 0 16 16" className={`${cls.cloud_1} ${cls.cloud}`}>
          <path
